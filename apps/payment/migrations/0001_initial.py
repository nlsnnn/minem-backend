    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider_payment_id', models.CharField(max_length=100, verbose_name='ID платежа у провайдера')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Сумма платежа')),
                ('payment_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата платежа')),
                ('status', models.CharField(choices=[('pending', 'В ожидании'), ('completed', 'Завершен'), ('failed', 'Неудачный'), ('refunded', 'Возвращен')], default='pending', max_length=50, verbose_name='Статус платежа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='payment.payment', verbose_name='Платеж')),
            ],
            options={
